...
for item in tqdm(demo_item_list):
    ...
    first_score,first_disguised_prompt,first_victim_response = security_method(harmful_prompt,attacker_pipe,attacker_tokenizer,victim_pipe,victim_tokenizer,judgetype,10)
...
for item in tqdm(demo_item_list):
    ...
    temp_disguised_prompt = "xxx"
    temp_victim_response = "xxx" 
    first_score,first_disguised_prompt,first_victim_response = word_method(harmful_prompt,attacker_pipe,attacker_tokenizer,victim_pipe,victim_tokenizer,judgetype,10)
    temp_score = first_score
    temp_disguised_prompt = first_disguised_prompt
    temp_victim_response = first_victim_response   
    if temp_score == 1.0:
