...
#     first_score,first_disguised_prompt,first_victim_response = char_method(harmful_prompt,attacker_pipe,attacker_tokenizer,victim_pipe,victim_tokenizer,judgetype,10)
